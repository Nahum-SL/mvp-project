            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <div className="absolute inset-0 rounded-3xl bg-linear-to-b from-blue-500/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none" />
                </Link>
              </motion.div>
            );
          })}
