...
export default function WhiteCard({
  ...
  return (
    <article className="flex flex-col justify-between rounded-3xl bg-gray-100 p-10 text-gray-800 shadow-[0_20px_50px_rgba(2,6,23,0.3)] transition-all duration-500">
