...
export const LeadsTable = ({ leads }: Props) => {
  ...
  if (leads.length === 0) {
    return (
      <div className="bg-white rounded-[2.5rem] p-20 flex flex-col items-center justify-center border-2 border-dashed border-slate-100">
        <div className="w-20 h-20 bg-slate-50 rounded-full flex items-center justify-center mb-6 text-slate-200">
          <Inbox size={40} />
        </div>
        <h3 className="text-xl font-black italic text-slate-300 uppercase">
          Bandeja Vacía
        </h3>
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-slate-50/50">
                <th className="px-6 py-6 text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 italic">
                  Cliente
                </th>
                <th className="px-6 py-6 text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 italic">
                  Contacto
                ...
                <th className="px-6 py-6 text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 italic text-right">
                  Acción
                </th>
              </tr>
            </thead>
