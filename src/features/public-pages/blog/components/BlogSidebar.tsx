...
// EXPORTADO --> src/features/containers/PostSlugContent.tsx
"use client";
    ...
    <div className="space-y-10">
      ...
      >
        <div className="mb-4 flex items-center justify-between px-2">
          <h4 className="text-[10px] font-extrabold text-slate-500 uppercase tracking-[0.3em]">
      ...
      >
        <div className="relative z-10">
          <h4 className="text-2xl font-extrabold text-white leading-tight mb-4 tracking-tighter">
          ...
          <div className="flex flex-col gap-3">
            ...
            <Link
              ...
              text-slate-950 font-extrabold rounded-2xl 
            ...
            <Link
              ...
              py-4 rounded-2xl font-extrabold text-[10px] uppercase tracking-widest 
      ...
      <div className="p-6 rounded-4xl border border-slate-900 bg-slate-950/50 backdrop-blur-md">
        <span className="text-[9px] font-extrabold text-slate-600 uppercase tracking-widest block mb-4">
          Escrito por
        </span>
        <div className="flex items-center gap-4">
          <div className="w-12 h-12 rounded-full bg-linear-to-br from-sky-500/20 to-blue-600/20 border border-sky-500/30 flex items-center justify-center text-white font-extrabold shadow-inner">
          ...
          <div>
            ...
            <p className="text-slate-500 text-[9px] uppercase font-extrabold tracking-tighter">
              {post.author.role}
            </p>
          </div>
        </div>
