...
export const PenaltyCalc = () => {
  const [regimen, setRegimen] = usePersistedState<"mype" | "general">(
    "asescon_penalty_regimen",
    "general",
  );
          ...
          <div className="group">
            ...
            >
              ...
              <button
                ...
                className={cn(
                  "py-3 rounded-xl text-[10px] font-extrabold uppercase tracking-widest transition-all",
                  regimen === "general"
