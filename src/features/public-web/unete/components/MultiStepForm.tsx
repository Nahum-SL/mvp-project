      ...
      <div className="flex justify-between pt-6">
        {!isFirstStep ? (
          <motion.button
            ...
            className="px-6 py-3 rounded-xl bg-slate-200 hover:bg-slate-300 transition-all font-medium"
          >
            Atrás
          </motion.button>
        ) : (
        ...
        {!isLastStep ? (
          <motion.button
            ...
            className="ml-auto px-6 py-3 rounded-xl bg-blue-600 text-white font-bold hover:bg-blue-700 shadow-md"
          >
            Siguiente
          </motion.button>
        ) : (
