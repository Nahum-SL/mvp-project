  ...
  const posteo = [
    {
      ...
      excerpt:
        "Descubre cómo la inteligencia artificial está transformando la forma en que desarrollamos software, desde la generación de código hasta la optimización de procesos.",
      category: "Tecnología",
      author: {
        name: "Nahum Salazar",
        role: "Desarrollador",
